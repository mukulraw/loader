...
public class Address3 extends AppCompatActivity {
    ...
    String src , des , tid , dat , wei , mid , loa , len , wid , hei , qua;
                ...
                if (padd.length() > 0)
                {
                    if (pcit.length() > 0)
                    {
                        if (ppin.length() > 0)
                        {
                                ...
                                if (dadd.length() > 0)
                                {
                                    if (dcit.length() > 0)
                                    {
                                        if (dpin.length() > 0)
                                        {
                                            ...
                                            {
                                                Toast.makeText(Address3.this, "Invalid drop mobile", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                        else
                                        {
                            ...
                            {
                                Toast.makeText(Address3.this, "Invalid pickup mobile", Toast.LENGTH_SHORT).show();
                            }
                        }
                        else
                        {
