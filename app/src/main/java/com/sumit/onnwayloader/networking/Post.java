...
import com.sumit.onnwayloader.addprofiledetails.UserData;
import com.sumit.onnwayloader.getpricenetworking.GetPrice;
import com.sumit.onnwayloader.myorder.ongoingorder.OngoingOrderDetails;
import com.sumit.onnwayloader.myorder.ongoingorder.OngoingOrderList;
import com.sumit.onnwayloader.myorder.pastorder.PastOrderDetails;
import com.sumit.onnwayloader.myorder.pastorder.PastOrderList;
import com.sumit.onnwayloader.myquotes.MyQuoteDetails;
import com.sumit.onnwayloader.myquotes.MyQuoteList;
import com.sumit.onnwayloader.myquotes.RecyclerAdapter;
import com.sumit.onnwayloader.otp.CheckingPreRegistered;
...
import com.sumit.onnwayloader.waitingrecycler.WaitingTruckDetails;
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    progressDialog.dismiss();
                    com.sumit.onnwayloader.waitingrecycler.RecyclerAdapter waitingRecyclerAdapter = new com.sumit.onnwayloader.waitingrecycler.RecyclerAdapter(WaitingTruckList.waitingTruckDetailsList);
                    LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context);
                    recyclerView.setLayoutManager(linearLayoutManager);
                    recyclerView.setHasFixedSize(true);
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    com.sumit.onnwayloader.myorder.ongoingorder.RecyclerAdapter recyclerAdapter =new com.sumit.onnwayloader.myorder.ongoingorder.RecyclerAdapter(OngoingOrderList.ongoingOrderLists);
                    LinearLayoutManager linearLayoutManager=new LinearLayoutManager(context);
                    recyclerView.setLayoutManager(linearLayoutManager);
                    recyclerView.setHasFixedSize(true);
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    progressDialog.dismiss();
                    // Toast.makeText(context, ""+arrpostedTruckDate[0]+arrpostedTruckDate[1], Toast.LENGTH_SHORT).show();
                    com.sumit.onnwayloader.myorder.pastorder.RecyclerAdapter recyclerAdapter =new com.sumit.onnwayloader.myorder.pastorder.RecyclerAdapter(PastOrderList.pastOrderList);
                    LinearLayoutManager linearLayoutManager=new LinearLayoutManager(context);
                    recyclerView.setLayoutManager(linearLayoutManager);
                    recyclerView.setHasFixedSize(true);
                    recyclerView.setAdapter(recyclerAdapter);
