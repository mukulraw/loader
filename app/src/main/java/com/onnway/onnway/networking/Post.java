package com.onnway.onnway.networking;
...
import com.onnway.onnway.addprofiledetails.FirstTimeProfileActivity;
import com.onnway.onnway.addprofiledetails.UserData;
import com.onnway.onnway.getpricenetworking.GetPrice;
import com.onnway.onnway.myorder.ongoingorder.OngoingOrderDetails;
import com.onnway.onnway.myorder.ongoingorder.OngoingOrderList;
import com.onnway.onnway.myorder.pastorder.PastOrderDetails;
import com.onnway.onnway.myorder.pastorder.PastOrderList;
import com.onnway.onnway.myquotes.MyQuoteDetails;
import com.onnway.onnway.myquotes.MyQuoteList;
import com.onnway.onnway.myquotes.RecyclerAdapter;
import com.onnway.onnway.otp.CheckingPreRegistered;
import com.onnway.onnway.otp.EnterNumberActivity;
import com.onnway.onnway.shipmentdetails.ShipmentActivity;
import com.onnway.onnway.shipmentdetails.ShipmentDetails;
import com.onnway.onnway.waitingrecycler.WaitingTruckDetails;
import com.onnway.onnway.waitingrecycler.WaitingTruckList;
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    progressDialog.dismiss();
                    com.onnway.onnway.waitingrecycler.RecyclerAdapter waitingRecyclerAdapter = new com.onnway.onnway.waitingrecycler.RecyclerAdapter(WaitingTruckList.waitingTruckDetailsList);
                    LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context);
                    recyclerView.setLayoutManager(linearLayoutManager);
                    recyclerView.setHasFixedSize(true);
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    com.onnway.onnway.myorder.ongoingorder.RecyclerAdapter recyclerAdapter =new com.onnway.onnway.myorder.ongoingorder.RecyclerAdapter(OngoingOrderList.ongoingOrderLists);
                    LinearLayoutManager linearLayoutManager=new LinearLayoutManager(context);
                    recyclerView.setLayoutManager(linearLayoutManager);
                    recyclerView.setHasFixedSize(true);
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    progressDialog.dismiss();
                    // Toast.makeText(context, ""+arrpostedTruckDate[0]+arrpostedTruckDate[1], Toast.LENGTH_SHORT).show();
                    com.onnway.onnway.myorder.pastorder.RecyclerAdapter recyclerAdapter =new com.onnway.onnway.myorder.pastorder.RecyclerAdapter(PastOrderList.pastOrderList);
                    LinearLayoutManager linearLayoutManager=new LinearLayoutManager(context);
                    recyclerView.setLayoutManager(linearLayoutManager);
                    recyclerView.setHasFixedSize(true);
                    recyclerView.setAdapter(recyclerAdapter);
