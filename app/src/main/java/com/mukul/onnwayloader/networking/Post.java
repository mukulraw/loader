package com.mukul.onnwayloader.networking;
...
import com.mukul.onnwayloader.addprofiledetails.FirstTimeProfileActivity;
import com.mukul.onnwayloader.addprofiledetails.UserData;
import com.mukul.onnwayloader.getpricenetworking.GetPrice;
import com.mukul.onnwayloader.myorder.ongoingorder.OngoingOrderDetails;
import com.mukul.onnwayloader.myorder.ongoingorder.OngoingOrderList;
import com.mukul.onnwayloader.myorder.pastorder.PastOrderDetails;
import com.mukul.onnwayloader.myorder.pastorder.PastOrderList;
import com.mukul.onnwayloader.myquotes.MyQuoteDetails;
...
import com.mukul.onnwayloader.shipmentdetails.ShipmentActivity;
import com.mukul.onnwayloader.shipmentdetails.ShipmentDetails;
import com.mukul.onnwayloader.waitingrecycler.WaitingTruckDetails;
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    progressDialog.dismiss();
                    com.mukul.onnwayloader.waitingrecycler.RecyclerAdapter waitingRecyclerAdapter = new com.mukul.onnwayloader.waitingrecycler.RecyclerAdapter(WaitingTruckList.waitingTruckDetailsList);
                    LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context);
                    recyclerView.setLayoutManager(linearLayoutManager);
                    recyclerView.setHasFixedSize(true);
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    com.mukul.onnwayloader.myorder.ongoingorder.RecyclerAdapter recyclerAdapter =new com.mukul.onnwayloader.myorder.ongoingorder.RecyclerAdapter(OngoingOrderList.ongoingOrderLists);
                    LinearLayoutManager linearLayoutManager=new LinearLayoutManager(context);
                    recyclerView.setLayoutManager(linearLayoutManager);
                    recyclerView.setHasFixedSize(true);
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    progressDialog.dismiss();
                    // Toast.makeText(context, ""+arrpostedTruckDate[0]+arrpostedTruckDate[1], Toast.LENGTH_SHORT).show();
                    com.mukul.onnwayloader.myorder.pastorder.RecyclerAdapter recyclerAdapter =new com.mukul.onnwayloader.myorder.pastorder.RecyclerAdapter(PastOrderList.pastOrderList);
                    LinearLayoutManager linearLayoutManager=new LinearLayoutManager(context);
                    recyclerView.setLayoutManager(linearLayoutManager);
                    recyclerView.setHasFixedSize(true);
                    recyclerView.setAdapter(recyclerAdapter);
