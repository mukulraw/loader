package com.onnway.app.networking;
...
import com.onnway.app.addprofiledetails.FirstTimeProfileActivity;
import com.onnway.app.addprofiledetails.UserData;
import com.onnway.app.getpricenetworking.GetPrice;
import com.onnway.app.myorder.ongoingorder.OngoingOrderDetails;
import com.onnway.app.myorder.ongoingorder.OngoingOrderList;
import com.onnway.app.myorder.pastorder.PastOrderDetails;
import com.onnway.app.myorder.pastorder.PastOrderList;
import com.onnway.app.myquotes.MyQuoteDetails;
import com.onnway.app.myquotes.MyQuoteList;
import com.onnway.app.myquotes.RecyclerAdapter;
import com.onnway.app.otp.CheckingPreRegistered;
import com.onnway.app.otp.EnterNumberActivity;
import com.onnway.app.shipmentdetails.ShipmentActivity;
import com.onnway.app.shipmentdetails.ShipmentDetails;
import com.onnway.app.waitingrecycler.WaitingTruckDetails;
import com.onnway.app.waitingrecycler.WaitingTruckList;
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    progressDialog.dismiss();
                    com.onnway.app.waitingrecycler.RecyclerAdapter waitingRecyclerAdapter = new com.onnway.app.waitingrecycler.RecyclerAdapter(WaitingTruckList.waitingTruckDetailsList);
                    LinearLayoutManager linearLayoutManager = new LinearLayoutManager(context);
                    recyclerView.setLayoutManager(linearLayoutManager);
                    recyclerView.setHasFixedSize(true);
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    com.onnway.app.myorder.ongoingorder.RecyclerAdapter recyclerAdapter =new com.onnway.app.myorder.ongoingorder.RecyclerAdapter(OngoingOrderList.ongoingOrderLists);
                    LinearLayoutManager linearLayoutManager=new LinearLayoutManager(context);
                    recyclerView.setLayoutManager(linearLayoutManager);
                    recyclerView.setHasFixedSize(true);
        ...
        CustomRequest jsObjRequest = new CustomRequest(Request.Method.POST, url, params, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    progressDialog.dismiss();
                    // Toast.makeText(context, ""+arrpostedTruckDate[0]+arrpostedTruckDate[1], Toast.LENGTH_SHORT).show();
                    com.onnway.app.myorder.pastorder.RecyclerAdapter recyclerAdapter =new com.onnway.app.myorder.pastorder.RecyclerAdapter(PastOrderList.pastOrderList);
                    LinearLayoutManager linearLayoutManager=new LinearLayoutManager(context);
                    recyclerView.setLayoutManager(linearLayoutManager);
                    recyclerView.setHasFixedSize(true);
                    recyclerView.setAdapter(recyclerAdapter);
